...
class ExaminationListView(InternMixin, OrderableMixin, SearchableMixin, CSVMixin, ListView):
    ...
    def get_extra_search_fields(self):
        ...
        gender_field = Examination._meta.get_field("patient_gender").formfield()
        education_field = Examination._meta.get_field("patient_education").formfield()
        age_min_field = Examination._meta.get_field("patient_age").formfield()
        age_max_field = Examination._meta.get_field("patient_age").formfield()
        ...
        return {
            "patient_gender": (gender_field, "icontains"),
            "patient_age__gte": (age_min_field, None),
            "patient_age__lte": (age_max_field, None),
            "patient_education": (education_field, "icontains"),
    ...
    def get_csv(self):
        ...
        writer.writerow([
            "ID",
            gettext("data"),
            gettext("wiek pacjenta"),
            gettext("płeć pacjenta"),
            gettext("wykształcenie pacjenta"),
            gettext("objawy"),
            gettext("choroby"),
        ...
        for obj in examinations:
            writer.writerow([
                ...
                obj.date,
                obj.patient_age,
                obj.get_patient_gender_display(),
                obj.get_patient_education_display(),
                ...
                list(obj.medicines.values("medicine__name", "intake_time")),
    ...
    def get_context_data(self, **kwargs):
        ...
        examinations = self.get_queryset().prefetch_related("travels")
